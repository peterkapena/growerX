...
export type ToggleOrderArchivedMutationVariables = Exact<{
  archived: Scalars['Boolean'];
  toggleOrderArchivedId: Scalars['String'];
}>;


export type ToggleOrderArchivedMutation = { __typename?: 'Mutation', toggleOrderArchived: boolean };
...
export const ToggleOrderArchivedDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ToggleOrderArchived"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"archived"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"toggleOrderArchivedId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"toggleOrderArchived"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"archived"},"value":{"kind":"Variable","name":{"kind":"Name","value":"archived"}}},{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"toggleOrderArchivedId"}}}]}]}}]} as unknown as DocumentNode<ToggleOrderArchivedMutation, ToggleOrderArchivedMutationVariables>;
